...
console.log("addresssss ",result)
  ...
  return (
    <>
      <div className="container my-3 p-4" style={{ border: '2px solid white', borderRadius: '10px' }}>
...
<div className="row">
          ...
          <div className="mb-3 col-md-4">
            ...
            <input name="fullName" value={formData.fullName} onChange={onChangeHandler}
              type="text" className="form-control bg-dark text-light" id="exampleInputEmail13" aria-describedby="emailHelp" />
          </div>
          <div className="mb-3 col-md-4">
...
<div className="mb-3 col-md-4">
  ...
  <input name="phoneNumber" value={formData.phoneNumber} onChange={onChangeHandler}
    type="number" className="form-control bg-dark text-light" id="exampleInputPassword1" />
</div>
...
<div className="row">
<div className="mb-3 ">
  <label htmlFor="exampleInputPassword1" className="form-label">Full Address</label>
...
{userAddress && (
  ...
  >
  <button className="btn btn-warning"> Use Previous address</button>
</div>
)}
